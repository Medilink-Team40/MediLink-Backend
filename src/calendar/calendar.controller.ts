...
import { CreateCalendarDto, UpdateCalendarDto, CalendarDayViewDto, CalendarWeekViewDto } from './dtos';
...
export class CalendarController {
  ...
  autoCreateCalendar(@Param('doctorId') doctorId: string, @Body() dto?: CreateCalendarDto) {
  ...
  updateCalendar(@Param('calendarId') calendarId: string, @Body() dto: UpdateCalendarDto) {
  ...
  @ApiOperation({
    ...
    description: 'Retorna todas las citas de un día específico compatible con FullCalendar',
  })
  @ApiParam({ name: 'calendarId', type: 'string' })
  @ApiQuery({
    name: 'date',
  ...
  getDayView(@Param('calendarId') calendarId: string, @Query('date') date: string): Promise<CalendarDayViewDto> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna todas las citas de una semana compatible con FullCalendar',
  })
  @ApiParam({ name: 'calendarId', type: 'string' })
  @ApiQuery({
    name: 'weekStart',
